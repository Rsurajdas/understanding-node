...
console.log(challengeMemoryContainer.toString("utf-8"));
*/
// Fastest way to create a buffer is using Buffer.from() and Buffer.allocUnsafe()
const challengeMemoryContainer = Buffer.from("486921", "hex");
console.log(challengeMemoryContainer.toString("utf-8"));
console.log(challengeMemoryContainer.byteLength);

const bytesLength = Buffer.byteLength("Suraj", "utf-8");
